...
<body>
    ...
    <div class="container">
        ...
        <form action="{{ route('buat-pesanan') }}" method="GET" class="search-container">
        ...
        <div id="product-modal" class="modal">
            <form action="{{ route('kasir.updateCart') }}" method="POST" class="modal-content">
                @csrf
                ...
                <div class="quantity-selector">
                    ...
                    <input type="number" id="modal-quantity"
                        value="{{ isset($cartItem) && $cartItem ? $cartItem->Quantity : 0 }}" min="0"
